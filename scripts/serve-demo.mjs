#!/usr/bin/env node
/**
 * Serves the repo root so the demo resolves ../dist/ exactly the way the
 * deployed GitHub Pages site does. Deliberately dependency-free.
 */
...
createServer((req, res) => {
    ...
    console.log(`Fireworksify demo → http://localhost:${PORT}/`);
});
