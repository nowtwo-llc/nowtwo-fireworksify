...
Fireworksify is a lightweight (~2.5k gzipped) browser library that adds animated fireworks effects to websites. It's a standalone TypeScript library with zero runtime dependencies, published as `@nowtwo-llc/fireworksify` to GitHub Packages.
